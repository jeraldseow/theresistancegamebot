...
#=====================================================
		if utils.get_curr_game(chat_id):
			...
			if date > curr_game.game_time + 60 and curr_game.state == 'player_addition':
				if curr_game.game_time + 120 - date > 0:
		...
		if text.startswith('/'):
			...
			if text == '/start':
				...
				curr_game = utils.get_curr_game(chat_id)
				if curr_game != None:
					announce(str(curr_game.yes_count + curr_game.no_count))
				return
				...
				if curr_game == None:
					...
					elif text == "/join" or text == "/join@theresistancegamebot":
						reply("You're already in the game! Enter /startgame to start the game once you have sufficient players!")
						...
						if text == '/leave' or text == "/leave@theresistancegamebot":
							...
							if num_players < 1:
								...
								for spy in utils.get_spy_list(chat_id):
									reply_to_user(spy.get_id(), u"You are: a Spy. \U0001F608 Go and wreak havoc with your friends " + line)
						...
						if text == '/yes' or text == '/no':
							...
							if curr_game.yes_count + curr_game.no_count == curr_game.num_player:
								if curr_game.yes_count > curr_game.no_count:
									...
									if curr_game.num_player > 6 and curr_game.mission_num == 4:
